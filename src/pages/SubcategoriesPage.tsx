...
const SubcategoriesPage: React.FC = () => {
  ...
  const handleSubcategoryClick = (
    ...
    navigate(`/subcategory/${categoryType}/${subcategoryId}/projects`);
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            {subcategories && subcategories.length > 0 ? (
                ...
                <div
                  ...
                  onClick={() =>
                    handleSubcategoryClick(
                      category_type as CategoryTypeModel,
                      subcategory.id
                    )
                  }
                  className="bg-white rounded-xl shadow-md p-4 cursor-pointer transform transition-all duration-200 hover:scale-105 hover:shadow-lg active:scale-95 border-l-4 border-blue-500"
                >
                  <div className="flex items-center space-x-3">
              ...
              <div className="text-center py-12">
                <p className="text-gray-500">Nenhuma sub-categoria encontrada.</p>
              </div>
            )}
          </div>
        </div>
