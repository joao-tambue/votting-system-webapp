...
const RankingPage: React.FC = () => {
  ...
  }, [categorizedProjectsMap, activeCategoryKey]);
  ...
  return (
    <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                  {activeProjects[1] && (
                    <div className="order-1">
                      <div className="bg-white bg-opacity-20 p-3 rounded-xl">
                        ...
                        <p
                          className="text-xs truncate max-w-[200px] mx-auto"
                          title={activeProjects[1].name}
                        >
                          {activeProjects[1].name}
                        </p>
                        <p className="text-xs">
                          {activeProjects[1].votes} votos
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="order-2">
                    <div className="bg-white bg-opacity-30 p-3 rounded-xl transform scale-110">
                      ...
                      <p
                        className="text-xs truncate max-w-[200px] mx-auto"
                        title={activeProjects[0].name}
                      >
                        {activeProjects[0].name}
                      </p>
                      <p className="text-xs font-bold">
                        {activeProjects[0].votes} votos
                      </p>
                    </div>
                  </div>
                  ...
                  {activeProjects[2] && (
                    <div className="order-3">
                      <div className="bg-white bg-opacity-20 p-3 rounded-xl">
                        ...
                        <p
                          className="text-xs truncate max-w-[200px] mx-auto"
                          title={activeProjects[2].name}
                        >
                          {activeProjects[2].name}
                        </p>
                        <p className="text-xs">
                          {activeProjects[2].votes} votos
                        </p>
                      </div>
                    </div>
                  )}
      ...
      <LoadingOverlay isVisible={loadingRanking} />
    </>
  );
};
